...
export function AppDashboardClient({ initialCursos }: Props) {
  const [cursos, setCursos] = React.useState<Curso[]>(initialCursos);
  ...
  React.useEffect(() => {
    // Por si cambian los cursos mientras navegas
    fetchCursos();
  }, [fetchCursos]);
